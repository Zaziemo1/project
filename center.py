...
title_label = tk.Label(frame1, text='Music Downloader', font=('Helvetica', 16), bg='#3498db', fg='white')
...
button3 = tk.Button(root, text="Button 1", image=logo, width=120)
button3.grid(row=1, column=2, padx=5, pady=5, sticky="nsew")
make_rounded_button(button3)

button4 = tk.Button(root, text="Button 1", image=logo, width=120)
button4.grid(row=2, column=0, padx=5, pady=5, sticky="nsew")
make_rounded_button(button4)

button6 = tk.Button(root, text="Button 1", image=logo, width=120)
