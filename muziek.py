...
class MyApp:
    def __init__(self, root):
        ...
        mixer.music.load("music\SR - Welcome to Brixton (Lyrics) Welcome to Brixton I'm in the party with barbies and drillas.mp3")  # Replace with the path to your audio file
